          ...
          isValidFirmantes(value) {
            ...
            value.forEach((firmante) => {
              if (
                ...
                throw new Error(
                  "Cada firmante debe tener nombre, apellido, telefono y mail"
                );
              }
            });
          },
    ...
    },
    {
      ...
      hooks: {
        beforeValidate: (contrato) => {
          // Eliminada la validación que involucraba fechaContrato
          // Ya que el campo fue completamente removido
        },
      },
    }
  );
